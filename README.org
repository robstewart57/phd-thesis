...
LaTeX, which is compiled to a PDF. A compiled PDF is available [[http://www.macs.hw.ac.uk/~rs46/phd-thesis.html][here]]. The HdpH-RS Haskell implementation described in Chapter 5 is [[https://github.com/robstewart57/hdph-rs][on GitHub]].
